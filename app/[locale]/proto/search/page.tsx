...
import { CATEGORIES, getCategoryLabel, searchArticles } from "../../../../lib/proto/mockData";
...
export default function SearchPage() {
  ...
  const results = useMemo(() => (submitted ? searchArticles(submitted) : []), [submitted]);
  ...
  const openStack = (kw: string) => router.push(`/${locale}/proto/stack?q=${encodeURIComponent(kw)}`);
