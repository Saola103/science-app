            ...
            <div className="mx-auto max-w-7xl px-6 py-12 flex flex-col lg:flex-row gap-12">
                ...
                <aside className="w-full lg:w-80 flex-none space-y-12">
                    <div className="space-y-4">
                        ...
                        <h1 className="text-4xl sm:text-6xl font-black tracking-tighter uppercase italic leading-none text-amber-600">{t("ニュースダイブ", "News Dive")}</h1>
                    ...
                    <div className="space-y-10">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-[10px] font-black tracking-[0.2em] text-amber-600 uppercase italic">Step 1: Select Topic</h3>
                                ...
                                {CATEGORIES_HIERARCHY.map(major => (
                                    <button
                                        ...
                                        className={`w-full text-left px-6 py-4 rounded-2xl border transition-all font-black text-xs uppercase tracking-widest ${activeMajor === major.id
                                                ...
                                                : "bg-slate-50 border-slate-100 text-slate-400 hover:border-amber-500/30 hover:text-slate-900"
                                            }`}
                                    >
                        ...
                        <div className="space-y-4 animate-in slide-in-from-left duration-500">
                            <h3 className="text-[10px] font-black tracking-[0.2em] text-amber-600 uppercase italic">Step 2: Narrow Down</h3>
                                ...
                                {activeMajorData.minors.map(minor => (
                                    <button
                                        ...
                                        className={`flex items-center gap-3 px-4 py-3 rounded-xl border transition-all text-[11px] font-black uppercase tracking-wider ${selectedMinors.includes(minor.id)
                                                ...
                                                : "bg-white border-slate-200 text-slate-500 hover:border-amber-500/30 hover:text-slate-900"
                                            }`}
                                    >
                        ...
                        {filteredNews.length > displayCount && (
                            <div className="flex justify-center pt-8">
                                <button
                                    ...
                                    className="px-12 py-5 rounded-2xl bg-slate-900 text-white font-black text-xs tracking-[0.2em] uppercase hover:bg-amber-600 hover:scale-105 transition-all shadow-xl shadow-slate-900/10"
                                >
